			...
			try {
				...
				if (p = p instanceof HTMLElement ? p : f[f.length - 1] || null) {
					...
					var v = (0 == e.config.meta.length ? h.defaultMeta : e.config.meta).map(function(t) {
							...
							return h.defaultMeta.indexOf(t) > -1 ? '<input name="' + t + '" placeholder="' + (e.config.metaPlaceholder[
								t] || e.i18n.t(t)) + '" class="v' + t + ' vinput" type="' + n + '">' : ""
						}),
						g =
		...
		o.prototype.Q = function(e) {
			...
			var C = function(t, n, r) {
					var o = (0, y.default)('<div class="vcard" id="' + t.id + '"></div>'),
						i = t.get("ua"),
						a = "";
					i && !/ja/.test(e.config.lang) && (i = y.default.detect(i), a = '<span class="vsys"><i class="fab fa-' + ([
								"xiaomi"
							].includes(i.browser.toLowerCase()) ? "mobile-alt fas" : i.browser.toLowerCase()) + '"></i>' + i.browser +
							" " + i.version + "</span>" + " " + ('<span class="vsys"><i class="fab fa-' + (["mac os", "ios"].includes(i
								.os.toLowerCase()) ? "apple" : i.os.toLowerCase()) + '"></i>' + i.os + " " + i.osVersion + "</span>")),
					...
					var ism = e.config.master.includes((0, s.default)(t.get("mail"))),
						...
						gat = ism ? '<span class="vtag vmaster">' + e.config.tagMeta[0] + '</span>' : isf ?
						'<span class="vtag vfriend">' + e.config.tagMeta[1] + '</span>' : '<span class="vtag vvisitor">' + e.config.tagMeta[
							2] + '</span>';
					...
					var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
						c = l ? '<a class="vnick" rel="nofollow" href="' + l + '" target="_blank" >' + t.get("nick") + "</a>" + gat :
						'<span class="vnick">' + t.get("nick") + "</span>" + gat,
						u = T.hide ? "" : qal ? '<img class="vimg" src="' + qal + '" referrerPolicy="no-referrer"/>' :
			...
			var z = e.$el.find(".vsubmit"),
				L = function(t) {
					...
					if (e.config.requiredFields.indexOf("mail") > -1 && !
						/^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/
						.test(E.mail)) return v.mail[0].focus(), void e.$el.find(".status-bar").text("" + e.i18n.t("mailFail")).empty(
						3e3);
